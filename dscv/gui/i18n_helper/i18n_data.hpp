			...
			namespace detail
			{
				...
				namespace lang_data
				{
					...
					constexpr auto k_data_ko_kr = make_array(
						...
						I18nData{ "Find", u8"찾기" },
						I18nData{ "Input File", u8"입력 파일" },
						I18nData{ "Input Files", u8"입력 파일" },
						I18nData{ "I/O Hybrid File", u8"입출력 혼합 파일" },
						...
						I18nData{ "Stream Addition", u8"스트림 추가" },
						I18nData{ "Stream Modification", u8"스트림 수정" },
